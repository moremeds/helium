...
The source spec `.../2026-09-01-option-wizard-team-tenant-design.md` is **not in
the repo**; this mapping is reconstructed from the 2026-09-01 decisions
`[INFERRED — verify roles against the spec before M2]`.

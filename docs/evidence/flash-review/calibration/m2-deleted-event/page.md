...
```json
{
  ...
  "catalysts": "ADBE and ORCL earnings post 2026-09-10; implied moves 6.93% and 9.86% set high bars for tech execution. MU earnings 2026-09-30 at 12.37% implied move tests memory cycle strength. ASML earnings 2026-10-14 (pre, 10.22% move) and TSM 2026-10-15 (7.86% move) define Q4 capex confidence.",
  "coverage": [
    {
      "id": "rates.front",
      "token": "untested",
